...
function getAllWords() {
  ...
  //populate with words
  populateDictionary(oneSyllable, twoSyllable,threeSyllable, fourSyllable, fiveSyllable);
  let wordCount = oneSyllable[0].length + oneSyllable[1].length + oneSyllable[2].length + oneSyllable[3].length  + oneSyllable[4].length + oneSyllable[5].length + twoSyllable[0].length +
  twoSyllable[1].length + twoSyllable[2].length + twoSyllable[3].length  + twoSyllable[4].length + twoSyllable[5].length + threeSyllable[0].length +
  threeSyllable[1].length + threeSyllable[2].length + threeSyllable[3].length  + threeSyllable[4].length + threeSyllable[5].length + fourSyllable[0].length +
  fourSyllable[1].length + fourSyllable[2].length + fourSyllable[3].length  + fourSyllable[4].length + fourSyllable[5].length + fiveSyllable[0].length +
  fiveSyllable[1].length + fiveSyllable[2].length + fiveSyllable[3].length  + fiveSyllable[4].length + fiveSyllable[5].length;
  document.getElementById("wordCount").innerHTML = wordCount;

  let singularVerbs = "";
  for (let k = 0; k < oneSyllable[0].length; k++) {
      singularVerbs = singularVerbs + oneSyllable[0][k].writtenWord + "    " ;
      wordCount = wordCount +  oneSyllable[0].length;
  }
...
function getRandomPoem(isMobile) {
  ...
  function populateDictionary(oneSyllable, twoSyllable,threeSyllable, fourSyllable, fiveSyllable) {
    //add a bunch of words to the dictionary
          ...
          twoSyllable[0].push(word);
          word = {writtenWord:"tussles",type:"verbSingular",syllables:2,style:"all"};
          twoSyllable[0].push(word);
          ...
          twoSyllable[1].push(word);
          word = {writtenWord:"tussle",type:"verbPlural",syllables:2,style:"all"};
          twoSyllable[1].push(word);
          ...
          twoSyllable[3].push(word);
          word = {writtenWord:"decor",type:"nounSingular",syllables:2,style:"all"};
          twoSyllable[3].push(word);
          ...
          twoSyllable[3].push(word);
          word = {writtenWord:"gnocchi",type:"nounSingular",syllables:2,style:"all"};
          twoSyllable[3].push(word);
          ...
          twoSyllable[3].push(word);
          word = {writtenWord:"palette",type:"nounSingular",syllables:2,style:"all"};
          twoSyllable[3].push(word);
          ...
          word = {writtenWord:"dahlia",type:"nounSingular",syllables:2,style:"all"};
          twoSyllable[3].push(word);
          ...
          //3 syllables
          word = {writtenWord:"petrichor",type:"nounSingular",syllables:3,style:"all"};
          ...
          threeSyllable[3].push(word);
          word = {writtenWord:"tragedy",type:"nounSingular",syllables:3,style:"all"};
          threeSyllable[3].push(word);
          ...
          threeSyllable[3].push(word);
          word = {writtenWord:"iliad",type:"nounSingular",syllables:3,style:"all"};
          threeSyllable[3].push(word);
          ...
          fourSyllable[3].push(word);
          word = {writtenWord:"fortune teller",type:"nounSingular",syllables:4,style:"all"};
          fourSyllable[3].push(word);
          //5 syllables
          ...
          oneSyllable[4].push(word);
          word = {writtenWord:"sylphs",type:"nounPlural",syllables:1,style:"all"};
          oneSyllable[4].push(word);
          ...
          twoSyllable[4].push(word);
          word = {writtenWord:"raindrops",type:"nounPlural",syllables:2,style:"all"};
          twoSyllable[4].push(word);
          ...
          word = {writtenWord:"dahlias",type:"nounPlural",syllables:2,style:"all"};
          twoSyllable[4].push(word);
          ...
          threeSyllable[4].push(word);
          word = {writtenWord:"tragedies",type:"nounPlural",syllables:3,style:"all"};
          threeSyllable[4].push(word);
          ...
          fourSyllable[4].push(word);
          word = {writtenWord:"fortune tellers",type:"nounPlural",syllables:4,style:"all"};
          fourSyllable[4].push(word);
          //5 syllables
          ...
          fiveSyllable[4].push(word);
          word = {writtenWord:"mathematicians",type:"nounPlural",syllables:5,style:"all"};
          fiveSyllable[4].push(word);
          ...
          twoSyllable[5].push(word);
          word = {writtenWord:"stunning",type:"adjective",syllables:2,style:"all"};
          twoSyllable[5].push(word);
          ...
          twoSyllable[5].push(word);
          word = {writtenWord:"jocose",type:"adjective",syllables:2,style:"all"};
          twoSyllable[5].push(word);
          ...
          twoSyllable[5].push(word);
          word = {writtenWord:"fuchsia",type:"adjective",syllables:2,style:"all"};
          twoSyllable[5].push(word);
          ...
          threeSyllable[5].push(word);
          word = {writtenWord:"camouflauged",type:"adjective",syllables:3,style:"all"};
          threeSyllable[5].push(word);
          ...
          threeSyllable[5].push(word);
          word = {writtenWord:"logarithmic",type:"adjective",syllables:3,style:"all"};
          threeSyllable[5].push(word);
          ...
          threeSyllable[5].push(word);
          word = {writtenWord:"mischievous",type:"adjective",syllables:3,style:"all"};
          threeSyllable[5].push(word);
          //4 syllables
          ...
          fourSyllable[5].push(word);
          word = {writtenWord:"colloquial",type:"adjective",syllables:4,style:"all"};
          fourSyllable[5].push(word);
          ...
          word = {writtenWord:"nefarious",type:"adjective",syllables:4,style:"all"};
          fourSyllable[5].push(word);
          word = {writtenWord:"ephemeral",type:"adjective",syllables:4,style:"all"};
          fourSyllable[5].push(word);
          ...
          fiveSyllable[5].push(word);
          word = {writtenWord:"irresistible",type:"adjective",syllables:5,style:"all"};
          fiveSyllable[5].push(word);
          ...
          //1 syllables
          word = {writtenWord:"pool",type:"wordOfGrouping",syllables:1,style:"all"};
          ...
          oneSyllable[6].push(word);
          word = {writtenWord:"note",type:"wordOfGrouping",syllables:1,style:"all"};
          oneSyllable[6].push(word);
          ...
          oneSyllable[6].push(word);
          word = {writtenWord:"thought",type:"wordOfGrouping",syllables:1,style:"all"};
          oneSyllable[6].push(word);
          ...
          oneSyllable[6].push(word);
          word = {writtenWord:"loaf",type:"wordOfGrouping",syllables:1,style:"all"};
          oneSyllable[6].push(word);
          ...
          word = {writtenWord:"detail",type:"wordOfGrouping",syllables:2,style:"all"};
          twoSyllable[6].push(word);
          ...
          twoSyllable[6].push(word);
          word = {writtenWord:"daydream",type:"wordOfGrouping",syllables:2,style:"all"};
          twoSyllable[6].push(word);
          ...
          // threeSyllable[6].push(word);
          word = {writtenWord:"undertone",type:"wordOfGrouping",syllables:3,style:"all"};
          threeSyllable[6].push(word);
          word = {writtenWord:"chariot",type:"wordOfGrouping",syllables:3,style:"all"};
          threeSyllable[6].push(word);
          ...
          // //adult
           ...
           twoSyllable[3].push(word);
           word = {writtenWord:"liqueur",type:"nounSingular",syllables:2,style:"all"};
           twoSyllable[3].push(word);
           ...
           threeSyllable[3].push(word);
           word = {writtenWord:"ecstasy",type:"nounSingular",syllables:3,style:"all"};
           threeSyllable[3].push(word);
           ...
           fourSyllable[3].push(word);
           word = {writtenWord:"purgatory",type:"nounSingular",syllables:4,style:"all"};
           fourSyllable[3].push(word);
           ...
           twoSyllable[4].push(word);
           word = {writtenWord:"liqueurs",type:"nounPlural",syllables:2,style:"all"};
           twoSyllable[4].push(word);
           ...
           threeSyllable[4].push(word);
           word = {writtenWord:"ecstasies",type:"nounPlural",syllables:3,style:"all"};
           threeSyllable[4].push(word);
